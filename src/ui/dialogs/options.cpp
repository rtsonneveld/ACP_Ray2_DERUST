...
void DR_DLG_Options_Draw() {
  ...
  if (ImGui::Begin("Options", &newSettings.dlg_options, ImGuiWindowFlags_NoCollapse)) {
    ...
    if (ImGui::BeginTabItem("Transparent ZDR walls/slopes")) {
    ...
    if (ImGui::BeginTabItem("Too Far Limit")) {
    ...
    if (ImGui::BeginTabItem("Distance checks")) {
