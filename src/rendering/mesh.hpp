...
public:
  ...
  static Mesh createCylinder(float radius, float height, unsigned int segments, glm::vec3 offset);
  static Mesh createCone(float radius, float height, unsigned int segments, glm::vec3 offset);
